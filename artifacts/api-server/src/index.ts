...
const SEED_AREAS = [
  ...
  { name: "Level 4 - Row C-G",                                terminal: "Terminal B - East", location: "East", sortOrder: 32 },
  { name: "Level 3 - Row A-G",                                terminal: "Terminal B - East", location: "East", sortOrder: 33 },
  { name: "Level 2 - Row A-G",                                terminal: "Terminal B - East", location: "East", sortOrder: 34 },
  { name: "Level 1 - Row D-G",                                terminal: "Terminal B - East", location: "East", sortOrder: 35 },
  { name: "R2 - Avis",                                        terminal: "Terminal B - East", location: "East", sortOrder: 36 },
  { name: "R1 - Hertz/Enterprise Return",                     terminal: "Terminal B - East", location: "East", sortOrder: 37 },
  { name: "Level 4 - Row H-M",                                terminal: "Terminal B - West", location: "West", sortOrder: 38 },
  { name: "Level 3 - Row H-P",                                terminal: "Terminal B - West", location: "West", sortOrder: 39 },
  { name: "Level 2 - Row H-P",                                terminal: "Terminal B - West", location: "West", sortOrder: 40 },
  { name: "Level 1 - Row H-P",                                terminal: "Terminal B - West", location: "West", sortOrder: 41 },
  { name: "R2 - Hertz",                                       terminal: "Terminal B - West", location: "West", sortOrder: 42 },
  { name: "R1 - Aloma/Enterprise Pick up",                    terminal: "Terminal B - West", location: "West", sortOrder: 43 },
  { name: "Taxis",                                            terminal: "Terminal B - West", location: "West", sortOrder: 44 },
  { name: "Garden",                                           terminal: "Terminal B - West", location: "West", sortOrder: 45 },
  { name: "Level 6 - C6 C59-C69",                             terminal: "Terminal C", location: "Level 6", sortOrder: 46 },
  { name: "Level 5 - C5 C59-C69",                             terminal: "Terminal C", location: "Level 5", sortOrder: 47 },
  { name: "Level 5 - Pedestrian Crossing",                    terminal: "Terminal C", location: "Level 5", sortOrder: 48 },
  { name: "Level 4 - C4 C59-C69",                             terminal: "Terminal C", location: "Level 4", sortOrder: 49 },
  { name: "Level 4 - Driveway",                               terminal: "Terminal C", location: "Level 4", sortOrder: 50 },
  { name: "Level 3 - C3 C59-C69",                             terminal: "Terminal C", location: "Level 3", sortOrder: 51 },
  { name: "Level 3 - Driveway/Pedestrian Walkway to trains",  terminal: "Terminal C", location: "Level 3", sortOrder: 52 },
  { name: "Level 3 - Pedestrian Walkway",                     terminal: "Terminal C", location: "Level 3", sortOrder: 53 },
  { name: "Level 2 - C2 Avis",                                terminal: "Terminal C", location: "Level 2", sortOrder: 54 },
  { name: "Level 2 - Pick up/Return Hertz, Return Hertz Pick up", terminal: "Terminal C", location: "Level 2", sortOrder: 55 },
  { name: "Level 2 - Pedestrian Walkway",                     terminal: "Terminal C", location: "Level 2", sortOrder: 56 },
  { name: "Level 1 - C1 Enterprise Return",                   terminal: "Terminal C", location: "Level 1", sortOrder: 57 },
  { name: "Level 1 - Sixt Return/Pick up",                    terminal: "Terminal C", location: "Level 1", sortOrder: 58 },
  { name: "Level 1 - Pedestrian Walkway",                     terminal: "Terminal C", location: "Level 1", sortOrder: 59 },
];
