...
- Weekly Report - Admin-only page aggregating all weekly activities: task completion by day, issues by severity/area, staff productivity rankings, area performance, photos shared, notifications sent; week navigation + print/PDF support; **Individual Staff Performance breakdown** table with per-staff metrics (tasks completed, special requests completed, issues resolved, issues reported, photos shared, areas worked); expandable rows with completion rate progress bar
